...
- **`interface/`** : Interface principale de l'application.
...
Pour accéder à notre interface, vous pouvez ouvrir le fichier `interface/index.html` dans votre navigateur web ou accéder la page au GitHub dans [ce lien](.). 
